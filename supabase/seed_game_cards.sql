...
('quizz', 'Les Marées', '{
  ...
  "answers": [
    ...
    "Les différences de température entre les océans",
    "Le vent dominant en surface"
  ],
...
('quizz', 'Les Marées', '{
  ...
  "answers": [
    "En observant la couleur de la mer",
    "En regardant la position de la Lune uniquement",
    "En utilisant un annuaire des marées ou une application (SHOM)",
    "En mesurant la vitesse du courant"
  ],
...
('quizz', 'Les Marées', '{
  ...
  "answers": [
    "Les différences de salinité retardent la marée",
    "Le fond marin est plus profond à certains endroits",
    "À cause de la rotation de la Terre uniquement",
    "La forme des côtes influence la propagation de l''onde de marée"
  ],
...
('quizz', 'Les Marées', '{
  ...
  "answers": [
    "La hauteur maximale atteinte par la marée",
    "Le moment de transition entre marée montante et descendante, où le courant est quasi nul",
    "La durée totale d''une marée",
    "La période où le courant est le plus fort"
  ],
  "correctAnswerIndex": 1,
...
('quizz', 'Les Marées', '{
  ...
  "answers": [
    "Il y aura moins d''organismes sur l''estran",
    "La mer sera plus calme et sans courant",
    "L''estran découvrira plus loin et les courants seront plus forts",
    "La marée montante sera plus rapide que la descente"
  ],
  "correctAnswerIndex": 2,
...
('quizz', 'Les Marées', '{
  ...
  "answers": [
    "Non, elle monte plus vite à la fin",
    "Non, elle monte plus vite au début",
    "Oui, la vitesse est constante",
    "Non, elle monte plus vite à mi-parcours (règle des douzièmes)"
  ],
  "correctAnswerIndex": 3,
...
('quizz', 'Les Marées', '{
  ...
  "answers": [
    "Elles créent du vent qui affecte les oiseaux",
    "Elles rythment la vie de toutes les espèces littorales et des activités comme la pêche ou la navigation",
    "Elles changent la couleur de l''eau selon le coefficient",
    "Uniquement parce qu''elles modifient la température de l''eau"
  ],
  "correctAnswerIndex": 1,
...
('quizz', 'Les Marées', '{
  ...
  "answers": [
    "À cause de la rotation de la Terre qui s''accélère légèrement",
    "Parce que la salinité de l''eau change chaque jour",
    "Parce que la journée lunaire dure 24h50, pas 24h, donc la Terre doit tourner un peu plus pour ''rattraper'' la Lune",
    "À cause du vent dominant qui ralentit la marée"
  ],
  "correctAnswerIndex": 2,
...
('quizz', 'Météo & Marées', '{
  ...
  "answers": [
    "Par l''évaporation de l''eau de mer",
    "Par la chaleur dégagée par le Soleil directement",
    "Par la rotation de la Terre uniquement",
    "Par des différences de pression atmosphérique : l''air se déplace des hautes vers les basses pressions"
  ],
  "correctAnswerIndex": 3,
...
('quizz', 'Météo & Marées', '{
  ...
  "answers": [
    "La terre se réchauffe plus vite que la mer, l''air chaud monte au-dessus de la terre et l''air frais de la mer prend sa place",
    "La mer se réchauffe plus vite que la terre le matin",
    "La différence de salinité crée un mouvement d''air",
    "Le vent général de la dépression est aspiré vers la côte"
  ],
  "correctAnswerIndex": 0,
...
('quizz', 'Météo & Marées', '{
  ...
  "answers": [
    "Un vent soufflant de la mer vers la plage, favorable au retour",
    "Un vent soufflant de la côte vers le large, qui peut éloigner du bord",
    "Un vent variable et faible",
    "Un vent parallèle à la côte, sans danger"
  ],
  "correctAnswerIndex": 1,
...
('quizz', 'Météo & Marées', '{
  ...
  "answers": [
    "L''air marin est plus léger et se déplace plus vite",
    "L''eau salée conduit mieux la chaleur",
    "La mer a une inertie thermique différente de la terre, et les systèmes météo se déplacent sans obstacles",
    "Les vagues accélèrent le déplacement des nuages"
  ],
  "correctAnswerIndex": 2,
...
('quizz', 'Météo & Marées', '{
  ...
  "answers": [
    "La pluie s''évapore avant d''atteindre le sol",
    "De la vapeur d''eau brûlante qui monte directement du sol",
    "Le vent pousse l''humidité vers le haut",
    "L''air chaud et humide monte, se refroidit, et la vapeur d''eau se condense autour de particules en suspension"
  ],
  "correctAnswerIndex": 3,
...
('quizz', 'Météo & Marées', '{
  ...
  "answers": [
    "Le cumulonimbus (développement vertical imposant)",
    "L''altocumulus (moutons blancs à altitude moyenne)",
    "Le stratus (nappe grise basse)",
    "Le cirrus (filaments blancs en altitude)"
  ],
  "correctAnswerIndex": 0,
...
('quizz', 'Météo & Marées', '{
  ...
  "answers": [
    "Elle annonce toujours une tempête",
    "Si le soleil tape fort le matin avec peu de vent, la brise se lève généralement en début d''après-midi",
    "Elle refroidit l''eau et rend la baignade difficile",
    "Elle crée des courants sous-marins dangereux"
  ],
  "correctAnswerIndex": 1,
...
('quizz', 'Météo & Marées', '{
  ...
  "answers": [
    "Du beau temps stable à venir",
    "Une remontée de vent de terre",
    "Une probable dégradation météo rapide (arrivée d''une dépression)",
    "Un changement de marée imminent"
  ],
  "correctAnswerIndex": 2,
...
('quizz', 'Repères spatio-temporels', '{
  ...
  "answers": [
    "Pour choisir la couleur de sa combinaison",
    "Pour connaître la direction du vent dominant",
    "Pour savoir si la mer sera chaude",
    "Pour évaluer la sécurité : un fort coefficient = courants plus puissants et estran qui découvre plus loin"
  ],
  "correctAnswerIndex": 3,
...
('quizz', 'Repères spatio-temporels', '{
  ...
  "answers": [
    "En observant le sens des nuages uniquement",
    "En mouillant son doigt et le levant : le côté qui refroidit indique d''où vient le vent",
    "En regardant la direction des vagues uniquement",
    "En regardant où volent les mouettes"
  ],
  "correctAnswerIndex": 1,
...
('quizz', 'Repères spatio-temporels', '{
  ...
  "answers": [
    "En regardant la direction des vagues de surface",
    "En goûtant l''eau — elle est plus salée dans le sens du courant",
    "En observant l''eau autour d''une bouée ou d''un poteau : une ''moustache'' d''écume se forme en aval",
    "En plongeant un bâton verticalement"
  ],
  "correctAnswerIndex": 2,
...
('quizz', 'Repères spatio-temporels', '{
  ...
  "answers": [
    "La profondeur minimale d''un chenal",
    "Un type de courant côtier dangereux",
    "Un signal sonore de brume",
    "Un point de repère visuel fixe à terre utilisé pour se localiser (clocher, phare, château d''eau)"
  ],
  "correctAnswerIndex": 3,
...
('quizz', 'Repères spatio-temporels', '{
  ...
  "answers": [
    "Pour pouvoir se localiser et retrouver son chemin, même si les conditions changent",
    "Pour impressionner les autres pratiquants",
    "Pour mesurer la vitesse du courant",
...
('quizz', 'Repères spatio-temporels', '{
  ...
  "answers": [
    "C''est une obligation légale uniquement",
    "La nature aura toujours le dernier mot : marées, vents, saisons — s''adapter c''est être en sécurité et en harmonie avec le milieu",
    "Pour des raisons touristiques uniquement",
    "Uniquement pour les pêcheurs professionnels"
  ],
  "correctAnswerIndex": 1,
...
('quizz', 'Caractéristiques du littoral', '{
  ...
  "answers": [
    "La limite légale de la mer sur la plage",
    "La zone toujours immergée même à marée basse",
    "La ligne de dépôts (algues, coquilles, débris) laissée par la mer au niveau de sa plus haute montée",
    "L''écume produite par les vagues"
  ],
  "correctAnswerIndex": 2,
...
('quizz', 'Caractéristiques du littoral', '{
  ...
  "answers": [
    "Par dépôt de sédiments fluviaux uniquement",
    "Par érosion des falaises par les vagues",
    "Par action des marées sur le sable",
    "Par accumulation de sable transporté par le vent, piégé par les plantes pionnières"
  ],
  "correctAnswerIndex": 3,
...
('quizz', 'Caractéristiques du littoral', '{
  ...
  "answers": [
    "Le piétinement détruit la végétation qui retient le sable, déclenchant l''érosion",
    "L''eau de mer les dissout progressivement",
    "Les dunes sont en fait très solides et résistantes",
    "Le sable est trop fin et s''envole facilement"
  ],
  "correctAnswerIndex": 0,
...
('quizz', 'Caractéristiques du littoral', '{
  ...
  "answers": [
    "Parce que les vagues apportent des nutriments du fond",
    "C''est une zone de rencontre entre terre et mer (écotone) qui multiplie les habitats et les ressources",
    "Uniquement parce qu''il y a moins de prédateurs",
    "Parce que l''eau y est plus chaude qu''au large"
  ],
  "correctAnswerIndex": 1,
...
('quizz', 'Caractéristiques du littoral', '{
  ...
  "answers": [
    "Du fond marin uniquement",
    "Des rivières qui se jettent à la mer uniquement",
    "De l''activité de la mer : algues décrochées, bois flotté, coquilles vidées, œufs de raie",
    "Uniquement des bateaux qui passent au large"
  ],
  "correctAnswerIndex": 2,
...
('quizz', 'Caractéristiques du littoral', '{
  ...
  "answers": [
    "L''affaissement du fond marin",
    "La progression des dunes vers l''intérieur des terres",
    "Le mouvement normal de la marée qui couvre et découvre la plage",
    "Le recul progressif de la limite terre/mer dû à l''érosion, accéléré par la montée des eaux et les tempêtes"
  ],
  "correctAnswerIndex": 3,
...
('quizz', 'Observation Sensorielle', '{
  ...
  "answers": [
    "En choisissant un point fixe (rocher, poteau) et en observant si le niveau monte ou descend par rapport à lui",
    "En regardant la direction du vent",
    "En comptant les vagues",
    "En goûtant l''eau — elle est plus salée quand la marée monte"
  ],
  "correctAnswerIndex": 0,
...
('quizz', 'Observation Sensorielle', '{
  ...
  "answers": [
    "La hauteur des vagues actuelles",
    "La laisse de haute mer : la ligne de débris (algues, bois) laissée par la dernière marée haute",
    "La couleur de l''eau au large",
...
('quizz', 'Observation Sensorielle', '{
  ...
  "answers": [
    "Uniquement l''odorat",
    "Il faut des instruments — les sens ne suffisent pas",
    "L''ouïe (bruit des vagues, oiseaux), l''odorat (iode, algues), parfois le toucher (texture des rochers)",
    "Uniquement le toucher"
  ],
  "correctAnswerIndex": 2,
...
('quizz', 'Observation Sensorielle', '{
  ...
  "answers": [
    "Faire du bruit pour que les animaux restent immobiles",
    "Observer uniquement les espèces protégées",
    "S''approcher le plus possible pour bien voir",
    "Rester à distance, ne pas faire de bruit, utiliser des jumelles — il y a dérangement dès qu''il y a un changement de comportement"
  ],
  "correctAnswerIndex": 3,
...
('quizz', 'Observation Sensorielle', '{
  ...
  "answers": [
    "Des coquillages, œufs de raie, os de seiche, algues — et la proportion de déchets humains renseigne sur la santé du milieu",
    "Uniquement des roches et du sable",
    "Uniquement des organismes vivants",
    "Uniquement des déchets plastiques"
  ],
  "correctAnswerIndex": 0,
...
('quizz', 'Observation Sensorielle', '{
  ...
  "answers": [
    "La couleur des rochers uniquement",
    "La présence de moutons (crêtes blanches), la hauteur des vagues, si elles cassent, la visibilité à l''horizon",
    "La température de l''air",
    "La présence de bateaux de pêche uniquement"
  ],
  "correctAnswerIndex": 1,
...
('quizz', 'Observation Sensorielle', '{
  ...
  "answers": [
    "Uniquement leur hauteur",
    "La direction du vent uniquement",
    "Leur hauteur, leur forme (creuses ou douces), leur fréquence, et s''il y a du ressac sur les zones rocheuses",
...
('quizz', 'Toutes les notions - comprendre', '{
  ...
  "answers": [
    "Elles ne s''y adaptent pas — c''est un milieu hostile vide de vie",
    "Elles vivent uniquement dans l''eau constamment",
    "Elles migrent à chaque marée",
    "Elles développent des adaptations spécifiques : carapaces (crabe), adhérence (patelle), dessèchement toléré (algues)"
  ],
  "correctAnswerIndex": 3,
...
('quizz', 'Toutes les notions - comprendre', '{
  ...
  "answers": [
    "Du phytoplancton aux grands prédateurs, chaque maillon est essentiel : la disparition d''un maillon affecte toute la chaîne",
    "Seuls les animaux du fond participent à la chaîne",
    "Les gros poissons mangent les petits, sans autre lien",
    "Les algues mangent les poissons"
  ],
  "correctAnswerIndex": 0,
...
('quizz', 'Toutes les notions - comprendre', '{
  ...
  "answers": [
    "Uniquement les activités industrielles",
    "Pêche, plaisance, sports nautiques, tourisme, transport maritime, extraction de ressources — nous partageons tous cet espace",
    "Uniquement la pêche professionnelle",
    "Uniquement le tourisme et la baignade"
  ],
  "correctAnswerIndex": 1,
...
('quizz', 'Toutes les notions - comprendre', '{
  ...
  "answers": [
    "Le tourisme balnéaire uniquement",
    "L''économie des pays côtiers uniquement",
    "Le développement d''activités économiques maritimes qui respectent la santé de l''océan sur le long terme",
    "La pêche industrielle intensive"
  ],
  "correctAnswerIndex": 2,
...
('quizz', 'Toutes les notions - comprendre', '{
  ...
  "answers": [
    "La lune, le soleil et la pluie",
    "La pression atmosphérique uniquement",
    "La température, la salinité et les marées uniquement",
    "Le vent, la rotation de la Terre (effet de Coriolis) et la forme des côtes / fonds marins"
  ],
  "correctAnswerIndex": 3,
...
('quizz', 'Toutes les notions - comprendre', '{
  ...
  "answers": [
    "Les courants transportent de l''eau riche en nutriments depuis les profondeurs vers la surface, permettant à la vie de prospérer",
    "Aucun — les nutriments restent toujours au fond",
    "Uniquement les courants profonds ont un rôle",
    "Les courants appauvrissent l''eau en nutriments"
  ],
  "correctAnswerIndex": 0,
...
('quizz', 'Toutes les notions - comprendre', '{
  ...
  "answers": [
    "Ce n''est pas le cas — chaque espèce vit indépendamment",
    "Le vent crée les vagues, les vagues façonnent la côte, la côte abrite des espèces — tout est lié dans un système complexe",
    "Seuls le vent et les marées sont liés",
    "L''interdépendance ne concerne que les espèces animales"
  ],
  "correctAnswerIndex": 1,
...
('quizz', 'Toutes les notions - observer', '{
  ...
  "answers": [
    "En creusant dans le sable",
    "Uniquement par les sons produits par les animaux",
    "Par les empreintes dans le sable humide, les plumes, les coquilles ouvertes, les algues arrachées",
    "Il est impossible de trouver des traces sans jumelles"
  ],
  "correctAnswerIndex": 2,
...
('quizz', 'Toutes les notions - observer', '{
  ...
  "answers": [
    "Uniquement si c''est une espèce protégée",
    "Par obligation légale uniquement",
    "Uniquement en zone de réserve naturelle",
    "Chaque signalement (pollution, espèce échouée, filet abandonné) peut déclencher une action de protection ou de recherche"
  ],
  "correctAnswerIndex": 3,
...
('quizz', 'Toutes les notions - observer', '{
  ...
  "answers": [
    "L''heure de haute/basse mer, l''amplitude, les zones de courant fort ou de ressac potentiel",
    "La couleur de l''eau uniquement",
    "Uniquement la hauteur de la mer au moment du départ",
    "La direction du vent uniquement"
  ],
  "correctAnswerIndex": 0,
...
('quizz', 'Toutes les notions - observer', '{
  ...
  "answers": [
    "Elles ne changent pas — les pratiques restent identiques depuis 50 ans",
    "Matériaux recyclés, moteurs électriques, zones protégées, codes de bonne conduite en mer — les choses changent",
    "Uniquement par l''interdiction de certaines activités",
    "Uniquement grâce aux réglementations obligatoires"
  ],
  "correctAnswerIndex": 1,
...
('quizz', 'Interactions des éléments climatiques', '{
  ...
  "answers": [
    ...
    "La houle est uniquement présente en océan, pas près des côtes",
    "La mer du vent est courte et désordonnée (vent local). La houle est longue et régulière, formée au large et ayant voyagé loin de sa zone de génération",
    "Les vagues sont plus grosses que la houle"
  ],
  "correctAnswerIndex": 2,
...
('quizz', 'Interactions des éléments climatiques', '{
  ...
  "answers": [
    "La profondeur, la salinité et la température de l''eau",
    "La lune, le soleil et la pression atmosphérique uniquement",
    "Le courant marin, la marée et la pression",
    "La vitesse du vent, la durée pendant laquelle il souffle, et le fetch (distance d''eau libre sur laquelle il souffle)"
  ],
  "correctAnswerIndex": 3,
...
('quizz', 'Interactions des éléments climatiques', '{
  ...
  "answers": [
    "Quand la profondeur de l''eau devient insuffisante, la base de la vague ralentit, la crête s''avance et ''trébuche'' : la vague déferle",
    "Les vagues déferlent uniquement lors des marées hautes",
    "Uniquement à cause du vent côtier",
    "Le déferlement est causé par le courant de marée uniquement"
  ],
  "correctAnswerIndex": 0,
...
('quizz', 'Interactions des éléments climatiques', '{
  ...
  "answers": [
    "Seul le courant de marée compte près des côtes",
    "Courants de marée, de dérive (vent) et généraux se combinent : leur addition peut créer des zones très agitées ou au contraire calmes",
    "Les courants généraux n''existent pas en Méditerranée",
    "Les courants de marée et les courants de vent n''interagissent jamais"
  ],
  "correctAnswerIndex": 1,
...
('quizz', 'Interactions des éléments climatiques', '{
  ...
  "answers": [
    "Uniquement parce qu''ils bloquent les hélices des bateaux",
    "Le milieu marin neutralise naturellement les plastiques en quelques années",
    "Les plastiques persistent des centaines d''années, se fragmentent en microplastiques, entrent dans la chaîne alimentaire et affectent tout l''écosystème marin",
...
('quizz', 'Interactions des éléments climatiques', '{
  ...
  "answers": [
    "Uniquement parce que les eaux y sont très froides",
    "Parce que la Normandie interdit toute activité humaine sur son littoral",
    "Uniquement parce qu''il est peu fréquenté",
    "Il combine des milieux diversifiés (mer, estran, dunes, estuaires, bocage) dans un équilibre fragile entre usages humains et nature"
  ],
  "correctAnswerIndex": 3,
...
('quizz', 'Général', '{
  ...
  "answers": [
    "Fuite = dépense d''énergie précieuse, abandon du nid, stress. Des parents dérangés peuvent abandonner leurs œufs ou leurs petits",
    "Seuls les oiseaux sont sensibles au dérangement",
    "Les animaux s''habituent rapidement à la présence humaine sans conséquences",
    "Uniquement parce que les animaux ont peur du bruit"
  ],
  "correctAnswerIndex": 0,
...
('quizz', 'Général', '{
  ...
  "answers": [
    "Observer mais ne jamais toucher quoi que ce soit",
    "Ne rien laisser derrière soi et respecter les chemins balisés",
    "Éviter d''aller à la plage en dehors des zones aménagées",
    "Ramasser uniquement les déchets plastiques"
  ],
  "correctAnswerIndex": 1,
...
('quizz', 'Général', '{
  ...
  "answers": [
    "Uniquement en faisant des dons à des associations",
    "La préservation est uniquement l''affaire des pouvoirs publics",
    "Signaler une espèce, ramasser un déchet, respecter les zones — chaque geste compte et les données citoyennes sont précieuses pour la recherche",
    "Uniquement les scientifiques peuvent contribuer"
  ],
  "correctAnswerIndex": 2,
...
('quizz', 'Général', '{
  ...
  "answers": [
    "Uniquement pour les personnes vivant près de la mer",
    "Uniquement à cause des algues toxiques",
    "Ce n''est pas lié — la santé humaine ne dépend pas de l''environnement marin",
    "La pollution de l''eau et de l''air cause des maladies. L''environnement est notre ''maison commune'' : s''il est en mauvais état, notre santé en pâtit"
  ],
  "correctAnswerIndex": 3,
...
('quizz', 'Général', '{
  ...
  "answers": [
    "La sensibilisation c''est la prise de conscience et l''information ; l''action c''est l''application concrète : changer ses habitudes, participer à des initiatives",
    "La sensibilisation suffit — l''action n''est pas nécessaire",
    "L''action est uniquement collective, la sensibilisation uniquement individuelle",
