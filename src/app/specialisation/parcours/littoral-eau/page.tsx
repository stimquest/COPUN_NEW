...
export default async function ParcoursLittoralEauPage() {
    ...
    return <main className="co-lesson-page"><ParcoursLaisseDeMerClient sequence={PARCOURS_LITTORAL_EAU} progression={progression} cards={cards} stages={stages} savedIds={saved.ids} initialChoices={saved.choices} /></main>;
}
